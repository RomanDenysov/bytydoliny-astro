		...
		<div className="max-w-screen-xl h-full mx-auto flex flex-col items-center bg-black">
			...
			<div className="flex px-6 w-full md:w-1/2 flex-col items-center justify-between gap-12 py-20">
				<span className="text-white text-xl font-semibold text-center">
					...
					Ďakujeme za Váš záujem. Váš email sme uložili do našej
					databázy. Pravidelne Vás budeme informovať o novinkách v
					projekte. V prípade, že máte záujem o kúpu bytu v projekte
					Byty Doliny kontaktujte nás prosím na{" "}
					<a
						className="underline text-primary"
						href="tel:+421948362720"
					>
						0948 362 720
					</a>{" "}
					alebo{" "}
