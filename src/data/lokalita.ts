export const LOKALITA_HERO = {
	title: "Lokalita",
	text: "Mesto Veľký Šariš susedí s krajským mestom Prešov a je s ním prepojené cyklochodníkom, mestskou hromadnou dopravou, železnicou ako aj cestou 1. triedy. Dostupnosť je vďaka tomu otázkou niekoľkých minút.",
};

export const LOKALITA_CARDS = [
	{
		id: 1,
		title: "Základné služby",
	...
	{
		id: 5,
		title: "Rybníky a chutné jedlo",
		text: "Lokalita Veľký Šariš je známa aj pre svoje rybníky, ktoré sú dôležitou súčasťou prírodnej scenérie v tejto oblasti. Okrem krásneho prírodného prostredia táto lokalita ponúka aj niečo pre milovníkov cyklistiky a výnimočných chutí.",
	},
];
